                ...
                <div id='main-credit-body'>
                    <div id='main-credit-product' ref={bigloneRef}>
                        ...
                        <div className='main-credit-text'>
                            ...
                            <div className='main-credit-text-detail'>
                                <ul>
                                    <li><p><span className='target-credit'>i-빅론U</span> 연 11.87% ~ 연 19.68% (고정금리) </p></li>
                                    <li>
                                        <p><span className='target-credit'>i-빅론U플러스</span> 연 7.30% ~ 연 19.68% (고정금리)</p>
                            ...
                            <div className='main-credit-text-detail'>
                                <ul>
                                    <li>
                                        <p>상환금액의 1.6%</p>
                                        <p>※ 중도상환금액 X 중도상환수수료율 (1.6%)
                                            <br /><span style={{ paddingLeft: "3.5vw" }}></span> X (대출 잔여기간 ÷ 대출기간)</p>
                                    </li>
                        ...
                        <div className='main-credit-text'>
                            ...
                            <div className='main-credit-text-detail'>
                                <ul>
                                    <li>
                                        <p>상환금액의 1.6%</p>
                                        <p>※ 중도상환금액 X 중도상환수수료율 (1.6%)  X (대출 잔여기간 ÷ 대출기간)</p>
                                    </li>
                                    <li><p>면제기준<br />: 대출취급일부터 3년 경과 시 중도상환수수료 면제</p></li>
                                </ul>
                            </div>
