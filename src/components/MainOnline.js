      ...
      <div className='base-date-integrate'>
        ...
        <div id='main-product-text-detail'>
          <ul>
            ...
            <li><p>
                ...
                4,500만원 이하에 해당하는 근로자<br/>
                ※ 단, 연소득 3,500만원 이하 (3개월 이상 재직 중)인 <br/>
                경우 개인신용평점과 무관하게 가능
            </p></li>
            <li><p>서민금융진흥원의 금융교육을 이수한 자</p></li>
            <li><p>서민금융진흥원 재무진단 평가모형 4등급 이하에<br/> 해당하는 근로자</p></li>
            <li><p>
                아래의 조건에 모두 해당하는 경우 신청 가능<br/>
                1) 현 직장 건강보험료 3개월 이상 정상 납부<br/><span style={{paddingLeft:'4.5vw'}}></span>
                 (현 직장 1개월 이상 근로 및 급여 수령 필수)<br/>
                2) 본인 명의의 공동인증서 또는 금융인증서,<br/><span style={{paddingLeft:'4.5vw'}}></span>
                휴대전화 보유<br/>
        ...
        <div id='main-product-text-detail'>
          <ul>
            <li><p>
                ...
                <span style={{paddingLeft:"17.5vw"}}></span>정기예금 가중평균 금리<br/>
        ...
        <div id='main-product-text-detail'>
          <ul>
            ...
            <li><p>
                보증료 우대사항<br/>
                1) 저소득 청년 (연소득 3,500만원 이하, 만 34세 이하) <br/><span style={{paddingLeft:'4vw'}}></span>0.5%p 인하<br/>
                2) 기타 (신용부채관리 컨설팅 이수자, 금융교육 이수자) <br/><span style={{paddingLeft:'4vw'}}></span>0.1%p 인하<br/>
                ※ 신용부채관리 컨설팅 및 금융교육 이수자: <br/><span style={{paddingLeft:'4vw'}}></span>
                '21.7.26.신규 신청접수분부터 신청일 이전 1년 이내<br/><span style={{paddingLeft:'4vw'}}></span>
                서민금융진흥원에서 해당 교육 이수한 경우<br/>
            </p></li>
            <li><p>보증료인하: 대출금리가 연 10.5%를 초과하는 경우,<br/> <span style={{paddingLeft:'18vw'}}></span>
            동 초과분 (대출금리-10.5%)의 60%에 <br/> <span style={{paddingLeft:'18vw'}}></span>
            해당하는 만큼의 보증료율 인하적용</p></li>
          </ul>
        </div>
        <div id='main-product-text-title'>
          <span>연체금리</span><hr />
