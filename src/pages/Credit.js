...
export default function Credit() {
  ...
  useEffect(() => {
    ...
    navigate(`/ibk/landing/credit?${params.toString()}`);
  }, [navigate]);

  useEffect(() => {
    //url 주소 가져오기
    // const urlAll = 'http://localhost:3000/ibk/landing/credit?adf_cd=25&utm_source=naver_brand&search=%EB%B3%B4%EC%A6%9D%EB%B6%80&n_media=27758&n_query=IBK%EC%A0%80%EC%B6%95%EC%9D%80%ED%96%89&n_rank=1&n_ad_group=grp-a001-04-000000041607267&n_ad=nad-a001-04-000000330861122&n_keyword_id=nkw-a001-04-000006153679739&n_keyword=IBK%EC%A0%80%EC%B6%95%EC%9D%80%ED%96%89&n_campaign_type=4&n_contract=tct-a001-04-000000001007674&n_ad_group_type=5&NaPm=ct%253Dm4j7rna8%257Cci%253D0yS00014UPvB0zBmd0XG%257Ctr%253Dbrnd%257Chk%253D81c569647ec1a7de1815160394c74db28732d449%257Cnacn%253DsuQLBYAOOebuB';
